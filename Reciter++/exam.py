...
B4 = Button(F2, text=language_metadata["BUTTON_START_TEST"][default_language], command=update_word)
...
B = Button(F2, text=language_metadata["BUTTON_CONFIRM"][default_language], command=confirm)
B.grid(row=3, column=0)
B1 = Button(F2, text=language_metadata["BUTTON_SKIP"][default_language], command=skip)
...
def update_word():
    ...
    try:
        ...
        tkinter.messagebox.showwarning(language_metadata["TITLE"][default_language],
                                       language_metadata["WARNING_CHOOSE_WL"][default_language])
        pass
...
def confirm():
    ...
    if test_started == 0:
        tkinter.messagebox.showwarning(language_metadata["Title"][default_language],
                                       language_metadata["WARNING_START_TEST"][default_language])
    else:
